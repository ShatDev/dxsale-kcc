(function ($) {
	...
	async function loadPresaleData(presaleAddress, form) {
		try {
			...
			$("#tokenAddress").text(address).attr("href", `https://explorer.kcc.io/en/address/${address}`);
			...
			$(form).html(`
                ...
                <div class="form-group col-md-12">
                  ...
                  <a target="_blank" href="https://explorer.kcc.io/en/address/${address}">${address}</a>
                </div>
				<div class="form-group col-md-12">
                  <label for="tokenAddress">Presale Address</label>
                  <a target="_blank" href="https://explorer.kcc.io/en/address/${presaleAddress}">${presaleAddress}</a>
                </div>
